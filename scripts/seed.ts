...
await db.insert(attendanceTable).values([
  ...
  { id: "att-003", scheduleId: SCH3_ID, studentId: S1_ID, ciId: CI2_ID, timeIn: new Date("2025-07-06T06:03:00Z"), timeOut: new Date("2025-07-06T14:10:00Z"), dutyHours: 8, status: "present",  method: "biometric", studentLatitude: 14.5794, studentLongitude: 120.9841, gpsVerified: true, faceVerified: true, livenessVerified: true },
  { id: "att-004", scheduleId: SCH3_ID, studentId: S3_ID, ciId: CI2_ID, timeIn: new Date("2025-07-06T06:10:00Z"), timeOut: new Date("2025-07-06T14:05:00Z"), dutyHours: 8, status: "present",  method: "biometric", studentLatitude: 14.5794, studentLongitude: 120.9841, gpsVerified: true, faceVerified: true, livenessVerified: true },
  ...
  { id: "att-006", scheduleId: SCH5_ID, studentId: S1_ID, ciId: CI1_ID, timeIn: new Date("2025-07-05T14:02:00Z"), timeOut: new Date("2025-07-05T22:15:00Z"), dutyHours: 8, status: "present",  method: "biometric", studentLatitude: 14.5577, studentLongitude: 121.0141, gpsVerified: true, faceVerified: true, livenessVerified: true },
  { id: "att-007", scheduleId: SCH5_ID, studentId: S4_ID, ciId: CI1_ID, timeIn: new Date("2025-07-05T14:30:00Z"), timeOut: new Date("2025-07-05T22:10:00Z"), dutyHours: 8, status: "late",     method: "biometric", studentLatitude: 14.5577, studentLongitude: 121.0141, gpsVerified: true, faceVerified: true, livenessVerified: true },
]).onConflictDoNothing();
